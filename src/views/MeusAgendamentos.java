...
public class MeusAgendamentos extends javax.swing.JFrame {
    Session session = Session.getInstance();
    int user_id = session.getUserId();
    String userName = session.getUserName();
    

    public MeusAgendamentos() throws SQLException {        
        initComponents();
    ...
    private void initComponents() {
        ...
        BotaoGerarCard = new javax.swing.JButton();
        ...
        jPanel3.setBackground(new java.awt.Color(9, 9, 10));

        jScrollPane1.setBackground(new java.awt.Color(9, 9, 10));
        ...
        BotaoGerarCard.setText("Gerar Card");
        BotaoGerarCard.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotaoGerarCardActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(BotaoGerarCard, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(BotaoGerarCard)
                .addContainerGap(13, Short.MAX_VALUE))
        );

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 90, 710, 500));
        ...
        jLabel4.setText("Meus Agendamentos");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 0, 200, 60));
        ...
        jPanel1.add(Background, new org.netbeans.lib.awtextra.AbsoluteConstraints(286, 0, 790, -1));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1070, 50));
    ...
    private void BotaoGerarCardActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoGerarCardActionPerformed
        try {
            ...
            String servico = model.getValueAt(selectedRow, 2).toString();
            String data = model.getValueAt(selectedRow, 3).toString();
            String hora = model.getValueAt(selectedRow, 4).toString();
            String observacao = model.getValueAt(selectedRow, 5).toString();
            String preco = model.getValueAt(selectedRow, 6).toString();

            Card card = new Card(barbeiro, cliente, servico, data, hora, observacao, preco);
            card.setVisible(true);
        } catch(Exception error) {
            JOptionPane.showMessageDialog(null, "Você precisa selecionar um agendamento!");
        }
    }//GEN-LAST:event_BotaoGerarCardActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MeusAgendamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(MeusAgendamentos.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    private javax.swing.JButton BotaoGerarCard;
