...
public class FeedbacksDAO {
    ...
    public void createFeedback(int user_id, int barber_id, boolean is_liked, String description) throws SQLException {
        try {
            Connection con = Conexao.faz_conexao();

            String sql = "INSERT INTO feedback (barber_id, user_id, is_liked, description) values (?,?,?,?)";
